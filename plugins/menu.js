...
let tags = {
  ...
  'search':'‎ 🔍أوامر البحث🔍',
  'audio-changer':'‎ 🎙️تعديل الصوتيات‎🎙️',
  'sticker':'‎ 🎟️أوامر الملصقات🎟️',
  'image-edit':'‎ 🎬تعديل الصور🎬',
  'pdf':'‎ 📑pdf ومشتقاته‎📑',
  'uploader':'‎‎ 🗳️رفع الملفات‎🗳️',
}
const defaultMenu = {
  before: `السلام عليكم إذا لم تدخل إلى المجموعة سيتم حضرك من استعمال البوت 👋. 
...
┗━━━━━━━━━━⬣
%readmore
  ≡ *O U S T O U R A | M E N U*
`.trimStart(),
  header: '┏━━⊜ *_%category_* ',
  body: '┃⋄ %cmd %isdiamond %isPremium',
  footer: '┗━━━━━━━━⬣\n',
  after: '*قال رسول الله صلى الله عليه وسلم: “إذا مات ابن آدم انقطع عمله إلا من ثلاث: صدقة جارية، أو علم ينتفع به، أو ولد صالح يدعو له” (رواه مسلم) ....فاللهم إجعل بوتيكال بوت صدقة جارية 📖*',}
