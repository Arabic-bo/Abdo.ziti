...
`.trimStart(),
  ...
  footer: '┗━━━━━━━━⬣\n',
  after: '*قال رسول الله صلى الله عليه وسلم: “إذا مات ابن آدم انقطع عمله إلا من ثلاث: صدقة جارية، أو علم ينتفع به، أو ولد صالح يدعو له” (رواه مسلم) ....فاللهم إجعل اسطورة بوت صدقة جارية 📖*',
}
